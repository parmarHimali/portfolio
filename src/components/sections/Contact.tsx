    ...
    <section id="contact" className="section-padding">
      <div className="container contact-container">
        <div className="contact-info-side">
          ...
          <div className="contact-methods">
            <a href={`mailto:${portfolioData.contact.email}`} className="contact-pill glass-effect">
              <Mail size={24} /> <span>{portfolioData.contact.email}</span>
            </a>
          </div>

          <div className="contact-socials">
            <a href={portfolioData.contact.github} target="_blank" rel="noreferrer" className="social-icon"><Github size={28} /></a>
            <a href={portfolioData.contact.linkedin} target="_blank" rel="noreferrer" className="social-icon"><Linkedin size={28} /></a>
          </div>
        </div>
      ...
      {modal.open && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className={`modal-content glass-effect ${modal.type}`} onClick={(e) => e.stopPropagation()}>
