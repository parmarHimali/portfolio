      ...
      <div className="container">
        ...
        <div className="projects-grid">
          {filteredProjects.map((project, idx) => (
            <div
              key={project.id}
              className="project-card-v2 glass-effect"
            >
              ...
              <div className="project-body">
                ...
                <div className="project-tech-stack">
                  {project.tech.map(t => <span key={t} className="tech-pill-v2">{t}</span>)}
                </div>
              </div>
              ...
              <div className="project-footer">
                {project.live && project.live !== "#" ? (
                  <a href={project.live} target="_blank" rel="noreferrer" className="btn-project-live">
                    View Project <ExternalLink size={16} style={{ marginLeft: '8px' }} />
                  </a>
                ) : (
